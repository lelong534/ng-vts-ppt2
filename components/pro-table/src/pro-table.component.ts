...
const defaultLabels: VtsProTableFixedButtons = {
  new: 'New',
  export: 'Export',
  import: 'Import',
  edit: 'Edit',
...
export class VtsProTableContainerComponent implements OnInit, OnChanges {
  ...
  @Input() vtsFixedButtonsConfig: VtsProTableFixedButtons = defaultLabels;
  ...
  ngOnChanges(changes: SimpleChanges) {
    if (changes.vtsFixedButtonsConfig) {
      this.render.labelRender$.next(this.vtsFixedButtonsConfig);
    }
